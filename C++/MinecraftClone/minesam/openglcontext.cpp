      ...
      while (m_app.pollEvent(Event))
      {
         ...
         case sf::Event::MouseWheelMoved:
            if (Event.mouseWheel.delta > 0)
               MousePressEvent(OpenglContext::MOUSE_BUTTON::MOUSE_BUTTON_WHEEL_UP, Event.mouseButton.x, Event.mouseButton.y);
            else
               MousePressEvent(OpenglContext::MOUSE_BUTTON::MOUSE_BUTTON_WHEEL_DOWN, Event.mouseButton.x, Event.mouseButton.y);
            break;
         }
      }
...
OpenglContext::MOUSE_BUTTON OpenglContext::ConvertMouseButton(sf::Mouse::Button button) const
{
   ...
   {
   case sf::Mouse::Left:
      return OpenglContext::MOUSE_BUTTON::MOUSE_BUTTON_LEFT;
   case sf::Mouse::Middle:
      return OpenglContext::MOUSE_BUTTON::MOUSE_BUTTON_MIDDLE;
   case sf::Mouse::Right:
      return OpenglContext::MOUSE_BUTTON::MOUSE_BUTTON_RIGHT;
   default:
      return OpenglContext::MOUSE_BUTTON::MOUSE_BUTTON_NONE;
   }
}
