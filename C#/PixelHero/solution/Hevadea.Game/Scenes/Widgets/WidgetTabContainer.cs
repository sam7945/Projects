...
namespace Hevadea.Scenes.Widgets
{
    ...
    public class WidgetTabContainer : Widget
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if(SelectedTab == Tabs.Last())
            {
                Rise.Sound.Play(Resources.SpecialSong);
                Rise.Scene.SetBackground(Resources.ParalaxeFactory);
            }
            else
            {
                Rise.Sound.Play(Resources.Overworld0);
                Rise.Scene.SetBackground(Resources.ParalaxeForest);
            }
