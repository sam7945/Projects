...
namespace Hevadea.Loading
{
    public static class Jobs
    {
        ...
        public class WorldGeneratorInfo : IJobArguments
        {
            ...
            public WorldGeneratorInfo(string path, int seed, Generator generator,string name=null)
            {
                Generator = generator;
                Path = path;
                Seed = seed;
        ...
        public static Job GenerateWorldOnline => new Job("GenerateWorld", (job, args) =>
        {
            var info = args as WorldGeneratorInfo;
            ...
            {
                SavePath = info.Path,
                World = info.Generator.GenerateOnline(job,info.Name)
            };
