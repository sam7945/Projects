    ...
    public static class TILES
    {
        ...
        public static void Initialize()
        {
            ...
            IRON_ORE = RegisterTile(new Tile("iron_ore", new TileRenderComposite(new Sprite(Resources.TileTiles, 10)),
                Color.Orange));
            GOLD_ORE = RegisterTile(new Tile("gold_ore", new TileRenderComposite(new Sprite(Resources.TileTiles, 11)),
                Color.Yellow));
            ...
            GROUPE_ROCK = new Groupe<Tile>("rock", IRON_ORE, GOLD_ORE,ROCK);
        ...
        public static void AttachRender()
        {
            ...
            IRON_ORE.Render = new TileRenderComposite(new Sprite(Resources.TileTiles, 10)) {ConnectTo = {ROCK,GOLD_ORE}};
            GOLD_ORE.Render = new TileRenderComposite(new Sprite(Resources.TileTiles, 11)) { ConnectTo = {ROCK,IRON_ORE}};
            ROCK.Render = new TileRenderComposite(new Sprite(Resources.TileTiles, 1)) {ConnectTo = {IRON_ORE,GOLD_ORE}};
        ...
        public static void AttachTags()
        {
            ...
            GOLD_ORE.AddTag(new DroppableTile(new Drop(ITEMS.GOLD_ORE, 1f, 1, 2)));
            GOLD_ORE.AddTag(new SolideTile(), new DamageTile { ReplacementTile = ROCK });
            GOLD_ORE.BlockLineOfSight = true;
