    ...
    public static class GENERATOR
    {
        ...
        public static void Initialize()
        {
                ...
                Features =
                {
                    new Terrain
                    {
                        Layers =
                        {
                            ...
                            new TerrainLayer
                            {
                                ...
                                Threashold = 1.2f,
                                TileRequired = {TILES.ROCK},
                                Function = Functions.Perlin(2, 1, 4),
                            }
                        }
                    },
                    new BspDecorator
                    ...
                    new CompoundFeature("Adding animals...")
                    {
                        Content =
                        {
                            ...
                            new Decorator(ENTITIES.DARKFLOWER)
                            {
                                Chance = 400,
                                CanBePlantOn = {TILES.DIRT},
                                PlacingFunction = Functions.Perlin(1, 0.5, 10),
                            ...
                            new Decorator(ENTITIES.DARKMUSHROOM)
                            {
                                Chance = 400,
                                CanBePlantOn = {TILES.DIRT},
                                PlacingFunction = Functions.Perlin(1, 0.5, 10),
                            ...
                            new Decorator(ENTITIES.DARKTREE)
                            {
                                Chance = 400,
                                CanBePlantOn = {TILES.DIRT},
                                PlacingFunction = Functions.Perlin(1, 0.5, 10),
                    ...
                    new Terrain
                    {
                        Layers =
                        {
                            ...
                            new TerrainLayer
                            {
                                ...
                                Tile = TILES.DIRT,
                                Threashold = 1.1f,
                                Function = Functions.Perlin(2, 1, 20)
                            },
                            //new TerrainLayer
                            //{
                            //    Priority = 1,
                            ...
                            new TerrainLayer
                            {
                                ...
                                Threashold = 1.2f,
                                TileRequired = {TILES.ROCK},
                                Function = Functions.Perlin(2, 1, 2),
                            },
                            new TerrainLayer
                            {
                                Priority = 2,
                    ...
                    new CompoundFeature("Adding animals...")
                    {
                        Content =
                        {
                            new Decorator(ENTITIES.ZOMBIE)
                            {
                                Chance = 400,
                                CanBePlantOn = {TILES.DIRT},
                                PlacingFunction = Functions.Perlin(1, 1, 10),
                                Threashold = 0.7f,
                            },
                            new Decorator(ENTITIES.DARKFLOWER)
                            {
                    ...
                    new Terrain
                    {
                        Layers =
                        {
                            ...
                            new TerrainLayer
                            {
                                ...
                                Tile = TILES.DIRT,
                                Threashold = 1.1f,
                                Function = Functions.Perlin(10, 1, 20)
                            },
                            //new TerrainLayer
                            //{
                            //    Priority = 1,
                            ...
                            new TerrainLayer
                            {
                                ...
                                Threashold = 1.2f,
                                TileRequired = {TILES.ROCK},
                                Function = Functions.Perlin(1, 1, 2),
                            },
                            new TerrainLayer
                            {
                                Priority = 2,
                    ...
                    new CompoundFeature("Adding animals...")
                    {
                        Content =
                        {
                            new Decorator(ENTITIES.ZOMBIE)
                            {
                                Chance = 400,
                                CanBePlantOn = {TILES.DIRT},
                                PlacingFunction = Functions.Perlin(2, 1, 1),
                                Threashold = 20.0f,
                            },
                            new Decorator(ENTITIES.DARKFLOWER)
                            {
            ...
            DEFAULT = new Generator
            {
                ...
                WorldFeatures = { new StairCaseFeature(OVERWORLD, CAVE), new StairCaseFeature(CAVE, DUNGEON), new StairCaseFeature(DUNGEON, DEEP_CAVE), new SpawnAreaFeature() }
            };
