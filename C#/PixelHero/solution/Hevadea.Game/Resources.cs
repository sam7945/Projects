...
namespace Hevadea
{
    public static class Resources
    {
        ...
        public static ParalaxeBackground ParalaxeFactory;
        ...
        public static Texture2D ImgArcher;
        public static Texture2D ImgMage;
        ...
        public static SoundEffect SwingAttack;

        public static Song Theme0;
        public static Song Overworld0;
        public static Song SpecialSong;

        public static void Load()
        {
            MakerLogo = Rise.Resources.GetImage("maker-logo");
            Sprites = new _SpriteAtlas(1024, 1024, "assets\\");
            ...
            ImgArcher = Rise.Resources.GetTexture("entities/archer");
            ImgMage = Rise.Resources.GetTexture("entities/mage");
            ImgArcher = Rise.Resources.GetTexture("entities/mush");
            ImgMage = Rise.Resources.GetTexture("entities/shrump");
            ...
            ParalaxeFactory = new ParalaxeBackground(
              new ParalaxeLayer(Rise.Resources.GetTexture("backgrounds/factory0"), 0f),
              new ParalaxeLayer(Rise.Resources.GetTexture("backgrounds/factory1"), 64f),
              new ParalaxeLayer(Rise.Resources.GetTexture("backgrounds/factory2"), 96f),
              new ParalaxeLayer(Rise.Resources.GetTexture("backgrounds/factory3"), 128f)
          );
            ...
            SwingAttack = Rise.Resources.GetSoundEffect("swing_fight");

            // Songs ----------------------------------------------------------
            Theme0 = Rise.Resources.GetSong("theme0");
            Overworld0 = Rise.Resources.GetSong("overworld0");
            SpecialSong = Rise.Resources.GetSong("specialsong");
        }
    }
}