...
namespace Hevadea.Entities.Components
{
    public sealed class ComponentHealth : EntityComponent, IEntityComponentUpdatable, IEntityComponentSaveLoad
    {
        ...
        public double NaturalregenerationSpeed { get; set; } = 2.5;
        public float Value
        {
            get;
            set;
        ...
        {
            //if (Game.WorldPlayer != null && Owner is Player)
            //{
            //    if (_thread == null)
            //    {
            //        _thread = new Thread(new ThreadStart(() =>
            //        {
            //            while (Game.WorldPlayer != null && Game.WorldPlayer?.Player.Health != 0)
            //            {
            //                if (Game.WorldPlayer.Player.Health != Value)
            //                {
            //                    Game.WorldPlayer.Player.Health = Value;
