    ...
    public class WidgetTextBox : Widget
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            if (selectionBegin >= textBound.Size.X - 16)
            {
                ...
                int posDebut = texte.Length - cursorMax;

                texte = texte.Substring(posDebut, cursorMax);
                selection = textBound.Size.X - 16;
                size.X = textBound.Size.X - 16;
            }
            spriteBatch.DrawString(Style.Font, texte, textBound, Style.TextColor, Anchor.Left, Scale(1f));
            if (Focused)
